-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\lab2_first_part\atan2_cordic_nw.vhd
...
-- Source Path: lab2_first_part/Sybsystem_FixPoint/atan2_cordic_nw
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF atan2_cordic_nw IS
  ...
  -- Signals
  SIGNAL y_in_signed                      : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL y_in_ext                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_in_reg_out_1                   : signed(33 DOWNTO 0);  -- sfix34_En15
  ...
  SIGNAL x_in_signed                      : signed(31 DOWNTO 0);  -- sfix32_En15
  SIGNAL x_in_ext                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_in_reg_out_1                   : signed(33 DOWNTO 0);  -- sfix34_En15
  ...
  SIGNAL zero                             : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL onePi_1                          : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL switch_compare_1_1               : std_logic;
  SIGNAL y_in_reg_neg_cast                : signed(34 DOWNTO 0);  -- sfix35_En15
  SIGNAL y_in_reg_neg_cast_1              : signed(34 DOWNTO 0);  -- sfix35_En15
  SIGNAL y_in_reg_neg_1                   : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_pre_quadcorr_out               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y0_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y0_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_2               : std_logic;
  SIGNAL switch_compare_1_3               : std_logic;
  SIGNAL x_in_reg_neg_cast                : signed(34 DOWNTO 0);  -- sfix35_En15
  SIGNAL x_in_reg_neg_cast_1              : signed(34 DOWNTO 0);  -- sfix35_En15
  SIGNAL x_in_reg_neg_1                   : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_pre_quadcorr_out               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x0_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp1                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_1_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y1                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y1_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y1_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_4               : std_logic;
  SIGNAL switch_compare_1_5               : std_logic;
  SIGNAL x_temp1                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_1_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x1                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x1_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift2                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp2                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_2_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y2                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y2_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y2_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_6               : std_logic;
  SIGNAL switch_compare_1_7               : std_logic;
  SIGNAL y_shift2                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp2                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_2_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x2                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x2_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift3                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp3                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_3_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y3                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y3_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y3_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_8               : std_logic;
  SIGNAL switch_compare_1_9               : std_logic;
  SIGNAL y_shift3                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp3                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_3_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x3                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x3_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift4                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp4                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_4_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y4                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y4_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y4_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_10              : std_logic;
  SIGNAL switch_compare_1_11              : std_logic;
  SIGNAL y_shift4                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp4                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_4_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x4                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x4_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift5                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp5                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_5_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y5                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y5_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y5_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_12              : std_logic;
  SIGNAL switch_compare_1_13              : std_logic;
  SIGNAL y_shift5                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp5                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_5_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x5                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x5_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift6                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp6                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_6_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y6                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y6_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y6_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_14              : std_logic;
  SIGNAL switch_compare_1_15              : std_logic;
  SIGNAL y_shift6                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp6                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_6_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x6                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x6_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift7                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp7                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_7_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y7                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y7_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y7_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_16              : std_logic;
  SIGNAL switch_compare_1_17              : std_logic;
  SIGNAL y_shift7                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp7                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_7_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x7                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x7_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift8                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp8                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_8_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y8                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y8_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y8_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_18              : std_logic;
  SIGNAL switch_compare_1_19              : std_logic;
  SIGNAL y_shift8                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp8                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_8_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x8                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x8_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift9                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp9                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_9_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y9                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y9_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y9_p_msb                         : std_logic;  -- ufix1
  SIGNAL switch_compare_1_20              : std_logic;
  SIGNAL switch_compare_1_21              : std_logic;
  SIGNAL y_shift9                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp9                          : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_temp_0_9_1                     : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x9                               : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x9_p                             : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL x_shift10                        : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp10                         : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y_temp_0_10_1                    : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y10                              : signed(33 DOWNTO 0);  -- sfix34_En15
  SIGNAL y10_p                            : signed(33 DOWNTO 0);  -- sfix34_En15
  ...
  SIGNAL z0                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s1                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp1                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_1_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z1                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z1_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp2                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_2_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z2                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z2_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s3                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp3                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_3_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z3                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z3_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s4                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp4                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_4_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z4                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z4_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s5                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp5                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_5_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z5                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z5_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s6                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp6                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_6_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z6                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z6_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s7                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp7                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_7_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z7                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z7_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s8                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp8                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_8_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z8                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z8_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s9                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp9                  : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_9_2                     : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z9                               : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z9_p                             : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s10                    : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp10                 : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_10_2                    : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z10                              : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z10_p                            : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_s11                    : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL lut_value_temp11                 : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL y_temp_0_11                      : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z11                              : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z11_p                            : signed(33 DOWNTO 0);  -- sfix34_En29
  SIGNAL z_out                            : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL z_temp3_cast                     : signed(32 DOWNTO 0);  -- sfix33_En29
  SIGNAL z_temp3_cast_1                   : signed(32 DOWNTO 0);  -- sfix33_En29
  SIGNAL z_temp3_1                        : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL z_temp2_1                        : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL z_temp1_1                        : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL z_out_adjust                     : signed(31 DOWNTO 0);  -- sfix32_En29
  SIGNAL angle_tmp                        : signed(31 DOWNTO 0);  -- sfix32_En29

BEGIN
  y_in_signed <= signed(y_in);

  y_in_ext <= resize(y_in_signed, 34);

  y_in_reg_out_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      y_in_reg_out_1 <= to_signed(0, 34);
  ...
  comp_zero <= '1' WHEN y_in_reg_out_1 > to_signed(0, 34) ELSE
      '0';
  ...
  x_in_ext <= resize(x_in_signed, 34);

  x_in_reg_out_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      x_in_reg_out_1 <= to_signed(0, 34);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  onePi_1 <= to_signed(1686629713, 32);

  
  switch_compare_1_1 <= '1' WHEN y_in_msb > '0' ELSE
      '0';

  y_in_reg_neg_cast <= resize(y_in_reg_out_1, 35);
  y_in_reg_neg_cast_1 <=  - (y_in_reg_neg_cast);
  y_in_reg_neg_1 <= y_in_reg_neg_cast_1(33 DOWNTO 0);
  ...
  x_in_reg_neg_cast <= resize(x_in_reg_out_1, 35);
  x_in_reg_neg_cast_1 <=  - (x_in_reg_neg_cast);
  x_in_reg_neg_1 <= x_in_reg_neg_cast_1(33 DOWNTO 0);
  ...
  lut_value_s1 <= to_signed(421657428, 34);
  ...
  lut_value_s2 <= to_signed(248918915, 34);
  ...
  lut_value_s3 <= to_signed(131521918, 34);
  ...
  lut_value_s4 <= to_signed(66762579, 34);
  ...
  lut_value_s5 <= to_signed(33510843, 34);
  ...
  lut_value_s6 <= to_signed(16771758, 34);
  ...
  lut_value_s7 <= to_signed(8387925, 34);
  ...
  lut_value_s8 <= to_signed(4194219, 34);
  ...
  lut_value_s9 <= to_signed(2097141, 34);
  ...
  lut_value_s10 <= to_signed(1048575, 34);
  ...
  lut_value_s11 <= to_signed(524288, 34);
  ...
  z_out <= z11_p(31 DOWNTO 0);

  z_temp3_cast <= resize(z_out, 33);
  z_temp3_cast_1 <=  - (z_temp3_cast);
  z_temp3_1 <= z_temp3_cast_1(31 DOWNTO 0);
